...
export const meta = {
  title: 'Create and deploy a Preact application with ZEIT Now',
  description: 'How to create your Preact project and deploy it with ZEIT Now.',
  ...
  lastEdited: '2019-08-16T15:01:01.000Z'
}

[Preact](https://preactjs.com/) is a fast 3kB alternative to React with the same modern API.

In this guide, we will cover how to set up a Preact application with [Preact CLI](https://github.com/preactjs/preact-cli) and how to deploy it with [ZEIT Now](/docs/v2).
...
<Snippet dark text="yarn global add preact-cli" />
<Caption>Installing Preact CLI globally with <GenericLink href="https://yarnpkg.com">Yarn</GenericLink>.</Caption>

Get started by setting up a Preact application with Preact CLI and the following command:

<Snippet dark text="preact create default my-preact-app && cd my-preact-app" />
<Caption>Bootstrapping a Preact application with <GenericLink href="https://github.com/preactjs/preact-cli">Preact CLI</GenericLink>.</Caption>

## Step 2: Deploying to ZEIT Now

With your project set up, you are ready to deploy your Preact application with [ZEIT Now](/now).

If you have not yet installed Now, you can do so by [installing Now CLI](/download).

You can now deploy your Preact application with **just a single command**:
